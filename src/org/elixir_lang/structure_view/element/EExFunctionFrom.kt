...
class EExFunctionFrom(val modular: Modular, val call: Call) : StructureViewTreeElement, Visible, NavigationItem {
    ...
    private val declaredNameArity: EEx.DeclaredNameArity by lazy { EEx.declaredNameArity(call) }

    private val declaredName: String get() = declaredNameArity.name ?: "unknown_name"

    private val arity: Int get() = declaredNameArity.arity ?: 0
