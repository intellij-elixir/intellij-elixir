...
class FunctionSymbol(
    ...
    companion object {
        ...
        fun fromClause(clause: Call): List<FunctionSymbol> {
            if (CallableDeclaration.headBindingFormOf(clause) != CallableDeclaration.Form.CLAUSE) return emptyList()
        ...
        fun fromDelegation(delegation: Call): List<FunctionSymbol> {
            if (CallableDeclaration.headBindingFormOf(delegation) != CallableDeclaration.Form.DELEGATION) {
                return emptyList()
            }
