...
class CallDefinitionStubImpl<T : CallDefinition> : StubbicBase<T>, CallDefinitionStub<T> {
    constructor(parentStub: ModuleStub<*>,
                ...
                callDefinitionClauseHeadArity: Int,
                parameters: List<String>,
                isAutoGeneratedName: Boolean,
                isGuard: Boolean) : super(
            parentStub,
        ...
        this.autoGeneratedName = isAutoGeneratedName
        this.guard = isGuard
    ...
    constructor(parentStub: ModuleStub<*>,
                ...
                parameters: List<String>,
                isAutoGeneratedName: Boolean,
                isGuard: Boolean) : super(parentStub, ModuleStubElementTypes.CALL_DEFINITION, name) {
    ...
    override fun parameters(): List<String> = parameters

    override fun isAutoGeneratedName(): Boolean = autoGeneratedName

    override fun isGuard(): Boolean = guard
    ...
    private val autoGeneratedName: Boolean
